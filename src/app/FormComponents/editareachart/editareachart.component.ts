...
@Component({
  selector: 'app-editareachart',
  templateUrl: './editareachart.component.html',
  styleUrls: ['./editareachart.component.scss']
})
export class EditareachartComponent {
  title = "";
  count:any;
  layout:any;
  values1:any;
  ...
  ngOnInit() {
    if(localStorage.getItem("areachartdata")) {
      ...
      this.count=this.areadata.count;
      this.layout = this.areadata.nolayout;
      this.values1=this.areadata.values1;
      this.values2=this.areadata.values2;
      this.values3=this.areadata.values3;
    }
  ...
  reloadComponent(self:boolean,urlToNavigateTo ?:string){
   ...
   const url=self ? this.router.url : "component/areachart";
