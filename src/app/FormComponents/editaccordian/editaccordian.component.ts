...
@Component({
  selector: 'app-editaccordian',
  templateUrl: './editaccordian.component.html',
  styleUrls: ['./editaccordian.component.scss']
})
export class EditaccordianComponent {
  title = "";
  layout:any;
  ...
  ngOnInit() {
    ...
    if(localStorage.getItem("accordiandata")) {
      ...
      this.layout = this.accordiandata.nolayout;
    }
    ...
    this.registerForm.get("nolayout")?.valueChanges.subscribe((result)=>{
      ...
      if(result == 1) {
        ...
        this.registerForm.get("description51")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(200)]);
        this.registerForm.get("title52")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(15)]);
        this.registerForm.get("description52")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(200)]);
        this.registerForm.get("title53")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(15)]);
        this.registerForm.get("description53")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(200)]);
        this.registerForm.get("title54")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(15)]);
        this.registerForm.get("description54")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(200)]);
        this.registerForm.get("title55")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(15)]);
        this.registerForm.get("description55")?.setValidators([Validators.required,Validators.minLength(3), Validators.maxLength(200)]);
      } else {
        this.registerForm.get("title1")?.clearValidators();
        this.registerForm.get("description1")?.clearValidators();
        this.registerForm.get("title2")?.clearValidators();
  ...
  reloadComponent(self:boolean,urlToNavigateTo ?:string){
   ...
   const url=self ? this.router.url : "component/accordian";
